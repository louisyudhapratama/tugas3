...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["hapus"])) {
    ...
    $pembelianController->hapusPembelian($idpembelian);
    header("Location: list_pembelian.php");
    exit();
}

$pembelian = $pembelianController->ambilSemuaPembelian();
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="row mb-5">
            <h2 class="col">List Pembelian</h2>
            <a href="tambah_pembelian.php" class="btn btn-primary col-md-4" name="tambah">Tambah Pembelian</a>
        </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                while ($row = $pembelian->fetch_assoc()) {
                    ...
                    echo "<td>
                        <a href='update_pembelian.php?idpembelian=" . $row['idpembelian'] . "' class='btn btn-warning btn-sm'>Ubah</a>
                        <form method='post' action='" . htmlspecialchars($_SERVER["PHP_SELF"]) . "' style='display: inline-block;'>
                            ...
                            <button type='submit' class='btn btn-danger btn-sm' name='hapus' onclick=\"return confirm('Anda yakin ingin menghapus pembelian ini?');\">Hapus</button>
                        </form>
                      </td>";
                    echo "</tr>";
                }
